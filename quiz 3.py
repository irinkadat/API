...
print(
    r.headers)  # სერვერიდან მიღებული პასუხის დამატებითი ინფორმაცია. მაგ. სერვერის დასახლება, კონტენტის ტიპი, ა.შ. შედეგი არის dict ტიპის
...
cursor.execute("INSERT INTO pizza(title, image, fat) VALUES (?, ?, ?)", (title, image, fat))
conn.commit()
conn.close()
